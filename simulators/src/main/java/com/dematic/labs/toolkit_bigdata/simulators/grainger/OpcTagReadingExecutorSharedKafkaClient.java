...
public final class OpcTagReadingExecutorSharedKafkaClient {
    ...
    private OpcTagReadingExecutorSharedKafkaClient(final OpcTagReaderConfiguration config) {
        this.config = config;
    }
    ...
    private void dispatchPerOpcTagReading(KafkaProducer<String, byte[]> kafkaProducer,
                                          final String opcTagId, final CountDownLatch latch) {
    ...
    public static void main(String[] args) {
        try {
            ...
            new OpcTagReadingExecutorSharedKafkaClient(config).execute();
        } catch (final Throwable any) {
